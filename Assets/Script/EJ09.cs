...
public class EJ09 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("Nombre: " + nombre1 + ", capital aportado: $" + aporte1 + " , Porcentaje del capital: %" + porcentaje1 + ", Monto total aportado: " + total + ".");
        Debug.Log("Nombre: " + nombre2 + ", capital aportado: $" + aporte2 + " , Porcentaje del capital: %" + porcentaje2 + ", Monto total aportado: " + total + ".");
        Debug.Log("Nombre: " + nombre3 + ", capital aportado: $" + aporte3 + " , Porcentaje del capital: %" + porcentaje3 + ", Monto total aportado: " + total + ".");
    }
